...
class ProjectBanglaFilmPicksCard extends StatefulWidget {
  const ProjectBanglaFilmPicksCard({super.key});

  @override
  State<ProjectBanglaFilmPicksCard> createState() => _ProjectBanglaFilmPicksCardState();
}

class _ProjectBanglaFilmPicksCardState extends State<ProjectBanglaFilmPicksCard> {
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      "03 / Flutter App: Bangla Film Picks",
                      style: TextStyle(
                        color: primaryTextColor,
                        fontSize: 12,
