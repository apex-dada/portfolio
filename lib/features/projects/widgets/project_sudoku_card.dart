...
class ProjectSudokuCard extends StatefulWidget {
  const ProjectSudokuCard({super.key});

  @override
  State<ProjectSudokuCard> createState() => _ProjectSudokuCardState();
}

class _ProjectSudokuCardState extends State<ProjectSudokuCard> {
